...
<body class="g-sidenav-show  bg-gray-100">
  <aside class="sidenav navbar navbar-vertical navbar-expand-xs border-0 border-radius-xl my-3 fixed-start ms-3 "
    ...
    <div class="sidenav-header">
      ...
      <a class="navbar-brand m-0" href="https://demos.creative-tim.com/soft-ui-dashboard/pages/dashboard.php"
        ...
        <span class="ms-1 font-weight-bold">MINITGO</span>
      </a>
    </div>
        ...
        <div class="col-12">
          <div class="card mb-4">
            <div class="card-header pb-0">
              ...
              <h6>Orders <sup class=" text-white rounded p-1 bg-danger">Live</sup> </h6>
            </div>
            <div class="card-body px-0 pt-0 pb-2">
              <div class="table-responsive p-0">
                <table class="table align-items-center mb-0" id="demoTable">
                  <thead>
                    <tr>
                      ...
                      <th class="text-center text-uppercase text-secondary text-xxs font-weight-bolder opacity-7">Cancel
                        Order</th>
                  ...
                  <tbody>
                    ...
                    <tr>
                      <td>
                        <div class="d-flex px-2 py-1">
                          ...
                          <div class="d-flex flex-column justify-content-center">
                            <h6 class="mb-0 text-sm">Product Name / price</h6>
                            <p class="text-xs text-secondary mb-0">user name</p>
                          </div>
                        </div>
                      </td>
                      <td>
                        <p class="text-xs font-weight-bold mb-0">10254</p>
                        <p class="text-xs text-secondary mb-0">COD</p>
                      </td>
                      <td class="align-middle text-center text-sm">
                        <span class="badge badge-sm bg-gradient-success">Devliverd</span>
                      </td>
                      <td class="align-middle text-center">
                        <span class="text-secondary text-xs font-weight-bold">23/04/18</span>
                      </td>
                      <td class="align-middle text-center">
                        <span class="text-secondary text-xs font-weight-bold">06:00 AM</span>
                      </td>
                    ...
                    <tr>
                      ...
                      <td class="align-middle text-center text-sm">
                        <span class="badge badge-sm bg-gradient-warning">Returned</span>
                      </td>
                      <td class="align-middle text-center">
                        <span class="text-secondary text-xs font-weight-bold">23/04/18</span>
                      </td>
      ...
      <div class="row">
        <div class="col-12">
          <div class="card mb-4">
            ...
            <div class="card-body px-0 pt-0 pb-2">
              <div class="table-responsive p-0">
                <table class="table align-items-center justify-content-center mb-0" id="totalorders">
                  <thead>
                    <tr>
                      <th class="text-uppercase text-secondary text-xxs font-weight-bolder opacity-7">Product name</th>
                      <th class="text-uppercase text-secondary text-xxs font-weight-bolder opacity-7">Price</th>
          ...
          <div class="row align-items-center justify-content-lg-between">
            <div class="col-lg-6 mb-lg-0 mb-4">
              <div class="copyright text-center text-sm text-muted text-lg-start">
                ...
                <a href="https://www.minitgo.com" class="font-weight-bold" target="_blank">Minitgo</a>
                for a better trend's.
              </div>
            </div>
            <div class="col-lg-6">
  ...
  <script>
    $(document).ready(function() {
      const clientid = 1832410;

      function fetchData() {
        $.ajax({
          url: `https://minitgo.com/api/fetch_live_orders.php?client_id=${clientid}`,
          type: 'GET',
          dataType: 'json',
          success: function(data) {
            ...
            $.each(data, function(index, order) {
              var row = $('<tr></tr>');
              row.append(
                '<td><div class="d-flex px-2 py-1"><div><img src="../assets/img/team-2.jpg" class="avatar avatar-sm me-3" alt="user1"></div><div class="d-flex flex-column justify-content-center"><h6 class="mb-0 text-sm">' +
                order.product_name +
              ...
              row.append(
                ...
                order.order_id + '</p><p class="text-xs badge text-secondary mb-0">' + order
                .payment_mode + '</p></td>');
              row.append(
              ...
              row.append(
                ...
                order.time + '</span></td>');
              row.append(
                '<td class="align-middle"><a href="javascript:;" class="badge badge-sm bg-gradient-danger">Cancel Order</a></td>'
                );
          ...
          complete: function() {
            ...
            setTimeout(fetchData, 9000); // Adjust the delay as needed
          }
        });
      }
    ...
    $(document).ready(function() {
      ...
      function fetchtotalData() {
        $.ajax({
          url: `http://localhost/minitgo/clientdashboard/api/fetch_total_orders.php?client_id=${clientid}`, // Corrected URL
          type: 'GET',
          dataType: 'json', // Specify JSON data type
          success: function(data) {
            $('#totalorders tbody').empty(); // Clear existing table rows
            $.each(data, function(index, order) {
              var row = $('<tr></tr>');
              row.append(
                '<td><div class="d-flex px-2 py-1"><div><img src="../assets/img/team-2.jpg" class="avatar avatar-sm me-3" alt="user1"></div><div class="d-flex flex-column justify-content-center"><h6 class="mb-0 text-sm">' +
          ...
          complete: function() {
            // Call fetchData again after a delay
            setTimeout(fetchtotalData, 9000); // Adjust the delay as needed
          }
        });
      }
      // Call fetchData initially
